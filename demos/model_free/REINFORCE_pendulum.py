...
nA = 9#env.action_space.shape[0] #-todo- Needs to change w.r.t. custom env
np.random.seed(1)
...
l_rate = [0.000001,0.00001,0.0001,0.001,0.008]
mean_rewards = []
mean_stddevs = []
mean_variances = []
episode_rewards = []
...
for l in l_rate:
    ...
    for e in range(epochs):
        ...
        while True:
            ...
            next_state,reward,done,_ = env.step([f]) #-todo- Needs to change w.r.t. custom env
